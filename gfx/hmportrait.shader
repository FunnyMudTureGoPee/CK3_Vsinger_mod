# if you have other mod override environment and have your 2D character overexposure, change Line 448
Includes = {
	...
	{		
		...
		[[
			PDX_MAIN
			{
				...
				// was float3 Color = Diffuse * 0.3f - 0.015f;
				float3 Color = Diffuse * 0.57 - 0.011f;

				Out.Color = float4( Color, Diffuse.a );
				Out.SSAOColor = float4( vec3( 0.0f ), 1.0f );

				return Out;
				// Shader modified by Alexis Stukov (https://steamcommunity.com/profiles/76561198360409417), firstly used by MOD https://steamcommunity.com/sharedfiles/filedetails/?id=2224124758
			}
		]]
	}
